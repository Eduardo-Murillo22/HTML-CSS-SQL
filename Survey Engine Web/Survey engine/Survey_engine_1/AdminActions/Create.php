...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if(!$_COOKIE['TITTLE']){
            ...
            $query = "INSERT INTO `entity_survey`(`survey_name`, `discription`, `start_date`, `end_date`) VALUES";
            $query .= "('" . $tittle . "',";
            $query .= " '" . $DIS . "',";
            $query .= " '" . $start . "',";
            $query .= " '" . $end . "')";
            ...
            $query = "INSERT INTO `entity_answers`(`question`, `answer`) VALUES";
            $query .= "('" . $Question . "',";
            $query .= " '". $type . $Answer . "')";
            echo $query . "<br/>";
            $result = $conn->query($query);
